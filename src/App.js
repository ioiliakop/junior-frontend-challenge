  ...
  render() {
    ...
    return (
      <div className="container-fluid pt-5">
        <div className="row">
        <div className="desktopBannerSpace d-none d-lg-inline-block ml-3 col-2">
        ...
        <div className="container col-10">
          ...
          <div className="row">
            ...
            <div className="col mb-3">
              <img src="/xe.png" alt="xe logo" className="mx-auto d-block d-lg-inline-block"/>
            </div>
          ...
          <div className="tabletBannerSpace d-none d-md-block d-lg-none mb-5">
            <img src="/banner_space_700x100.png" alt="tablet banner" className="border border-dark"/>
          </div>
        </div>
        </div>
      </div>
